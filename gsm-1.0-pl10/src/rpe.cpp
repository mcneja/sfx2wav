...
(
	const s16 * e, /* signal [-5..0.39.44]	IN  */
	s16 * x        /* signal [0..39]		OUT */
)
/*
...
#undef	STEP
#define	STEP( m, i )	L_temp = x[m + 3 * i] / 4;	\
...
)
{
	...
	s16	xmax, xmaxc, temp, temp1, temp2;
	s16	exp, mant;
 ...
 */
{
	...
	s16 temp1 = gsm_FAC[ mant ];	/* see 4.2-15 for mant */
	s16 temp2 = gsm_sub( 6, exp );	/* see 4.2-15 for exp  */
	s16 temp3 = gsm_asl( 1, gsm_sub( temp2, 1 ));
...
(
	s16         Mc,		/* grid position IN	*/
	const s16 * xMp,	/* [0..12]		IN	*/
	s16 *       ep		/* [0..39]		OUT	*/
)
/*
